...
class Game:
    resolution = pygame.Vector2(1920, 1000) # (1800, 950)
    ...
    def __init__(self):
        ...
        self.PlayBtn = button.Button(image=None, pos=(self.resolution.x / 2, 500), text_input="Play", font=self.get_font(75), base_color="#da5e53", hover_color="#683b4c")           
        self.ControlsBtn = button.Button(image=None, pos=(self.resolution.x / 2, 650), text_input="Controls", font=self.get_font(75), base_color="#da5e53", hover_color="#683b4c")       
        self.QuitBtn = button.Button(image=None, pos=(self.resolution.x / 2, 800), text_input="Quit", font=self.get_font(75), base_color="#da5e53", hover_color="#683b4c")
